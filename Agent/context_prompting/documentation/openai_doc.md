...
/
Architecture
PlaygroundPlaygroundDashboardDashboardDocsDocsAPI referenceAPI


SearchK
API Reference
IntroductionAuthenticationDebugging requestsBackward compatibility
Responses
ResponsesStreaming
Chat Completions
...
Realtime 
Beta
RealtimeSession tokensClient eventsServer events
Platform APIs
AudioImagesEmbeddingsEvalsFine-tuningGradersBatchFilesUploadsModelsModerations
Vector stores
Vector storesVector store filesVector store file batches
Containers
ContainersContainer Files
Assistants 
Beta
AssistantsThreadsMessagesRunsRun stepsStreaming
Administration
AdministrationAdmin API KeysInvitesUsersProjectsProject usersProject service accountsProject API keysProject rate limitsAudit logsUsageCertificates
Legacy
Completions
Claim free tokens
...
curl https://api.openai.com/v1/models \
  ...
  -H "OpenAI-Organization: org-4kBIiL2cGiN2bNG0niayGZKh" \
